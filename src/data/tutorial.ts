...
/**
 * 初回プレイ時のチュートリアル。
 * 秘書役のキャラクターが執務室→政策→ニュース→市場→外交→翌月へを案内する。
...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    mode: "status",
    title: "そして時間を進める",
    text: "ひと通り手を打ったら『翌月へ』で時間を進めます。1か月が経ち、政策の効果が表れ、新たな出来事も起こります。これがこの国の一日の流れです。",
    focus: "右下の『翌月へ』で1か月進みます",
  },
  {
    speaker: "finance",
    mode: "status",
    title: "あなたの物語を",
    text: "説明は以上です。あとは、あなたの決断ひとつひとつが歴史になります。さあ、始めましょう——大統領。",
  },
];
